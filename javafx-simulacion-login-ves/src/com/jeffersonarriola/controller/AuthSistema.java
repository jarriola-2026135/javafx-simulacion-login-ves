...
import com.jeffersonarriola.model.Rol;
import com.jeffersonarriola.model.Usuario;
...
public class AuthSistema {
    ...
    public AuthSistema(){
        ...
        Usuario usuarioUser = new Usuario("user",
                                   "user", "user", Rol.USER);
        Usuario usuarioYo = new Usuario("Jefferson",
                                "123", "Jefferson Alexander Arriola", Rol.ADMIN);
